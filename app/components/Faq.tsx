...
const faqs = [
  {
    question: "What is a data center and why is it important?",
    answer:
      "A data center is a facility used to house critical IT infrastructure such as servers, storage systems, and networking equipment. It ensures data availability, security, scalability, and uninterrupted business operations.",
  },
  {
    question: "How do you ensure high availability and uptime?",
    answer:
      "We design data centers using redundant power, cooling, and network architectures (N+1 / 2N), combined with real-time monitoring and preventive maintenance to ensure maximum uptime.",
  },
  {
    question: "Are your data centers scalable for future growth?",
    answer:
      "Yes, our data centers are designed with modular and scalable infrastructure, allowing seamless expansion as business and technology demands grow.",
  },
  {
    question: "How is data security maintained in your facilities?",
    answer:
      "We implement multi-layered security including biometric access, 24/7 surveillance, firewalls, encryption, and compliance with global standards such as ISO and TIA.",
  },
];
...
const Faq = () => {
  ...
  return (
    <section className="relative w-full h-full overflow-hidden">
      ...
      <div className="relative max-w-2xl ml-20 py-24">
        <div className="max-w-2xl relative">
          
          {/* ===== PREMIUM WATERMARK HEADER (BACKGROUND) ===== */}
          <div className="absolute -top-32 left-14 pointer-events-none select-none">
            <div
              className="text-[140px] font-bold tracking-tighter opacity-[0.1]"
          ...
          {/* ===== HEADING ===== */}
          <h2 className="relative text-5xl font-semibold text-gray-900 leading-tight mb-6"   style={{ fontFamily: "'IBM Plex Sans', sans-serif", fontWeight: '500' }}>
            You’ve got questions, <br />
            <span className="text-[#1F4FA3]">we’ve got answers.</span>
          </h2>

          <div className="w-16 h-[3px] bg-[#6BB6E8] mb-12" />
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`border rounded-md overflow-hidden transition-colors duration-500  ${
                    isOpen
                      ? "border-[#1F4FA3] bg-[#1F4FA3]"
                ...
                >
                  ...
                  >
                    <div className="overflow-hidden">
                      <p
                              style={{ fontFamily: "'IBM Plex Sans', sans-serif", fontWeight: '500' }}
                        className={`px-6 pb-6 leading-relaxed transition-colors duration-500 ${

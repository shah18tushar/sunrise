...
export const menuItems = [
  { name: "Home", icon: IoHome, route: "/" },
  { name: "Services", icon: IoBriefcase, route: "/servicespage" },
  { name: "Contact Us", icon: IoMail, route: "/contactuspage" },
  // { name: "Portfolio", icon: IoImages, route: "/portfolio" },
  { name: "About Us", icon: IoInformationCircle, route: "/aboutuspage" },
];
